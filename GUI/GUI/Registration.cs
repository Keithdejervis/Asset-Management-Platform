...
namespace GUI
{
    public partial class Registration : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            string Surname = textBoxRegSurname.Text;

            string Portfolio = textBoxPort.Text;
            string Email = textBoxEMail.Text;
            string PhoneNumber = textBoxPhNumber.Text;
            string RiskPreference = textBoxRisk.Text;
            string Region = textBoxRegion.Text;
            string Country = textBoxCountry.Text;

      
            dbConn.SaveToDB("INSERT INTO Client (Name, Surname, Portfolio, Email, PhoneNumber, RiskPreference, Region, Country) VALUES (@Name, @Surname, @Portfolio, @Email, @PhoneNumber, @RiskPreference, @Region, @Country)", Name, Surname, Portfolio, Email, PhoneNumber, RiskPreference, Region, Country );
